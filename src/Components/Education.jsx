        ...
        <div name="Education">
            <div className="bg-gradient-to-r from-black to-purple-800 bg-center bg-cover bg-fixed text-white py-12 px-4 md:px-20 ">
                    ...
                    <div className="bg-[#252734] p-6 mx-5 rounded-lg relative border-l-4 border-[#7079F8]">
                        <div className="flex items-center space-x-4 mb-4">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-gray-400">Bachelor of Engineering - Computer Science Engineering</p>
                                <p className="text-sm text-gray-400">Feb 2020 - May 2024</p>
                            </div>
                        </div>
                        <p className="text-gray-400 mb-2">Grade: 8.49 CGPA</p>
                        <p className="text-gray-300 md:text-lg text-sm">
                            I have completed my Bachelors Of Engineering in Computer Science Engineering at Atharva College Of Engineering with an CGPA of 8.49
                        </p>
                    ...
                    <div className="bg-[#252734] p-6 mx-5 rounded-lg relative border-l-4 border-[#7079F8]">
                        <div className="flex items-center space-x-4 mb-4">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-gray-400">HSC(XII), Science with Information Tecnology</p>
                                <p className="text-sm text-gray-400">July 2019 - Apr 2020</p>
                            </div>
                        </div>
                        <p className="text-gray-400 mb-2">Grade: 74%</p>
                        <p className="text-gray-300 md:text-lg text-sm">
                ...
                <div className="bg-[#252734] p-6 mt-8  mx-5 rounded-lg relative border-l-4 border-[#7079F8]">
                    ...
                    <p className="text-gray-400 mb-2">Grade: 75%</p>
                    <p className="text-gray-300 md:text-lg text-sm">
